...
class TestMergePDFService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.image_service = ImageService(self.mock_merger, self.imgFilePathCollection, self.targetFilePath)
    ...
    def test_setTargetFilePath_sets_targetFilePath(self):
        ...
        self.assertEqual(self.image_service.getTargetFilePath(), new_target_path)

    def test_remove_prefix_removes_prefix(self):
        text = 'file:///test/path/to/file.jpg'
        prefix = 'file://'
        expected_result = '/test/path/to/file.jpg'
        self.assertEqual(self.image_service.remove_prefix(text, prefix), expected_result)

    def test_appendToQueue_adds_item_to_filePathList(self):
        item = QUrl.fromLocalFile('test_image3.jpeg')
        self.image_service.appendToQueue(item)
        expected_list = ['test_image1.jpg', 'test_image2.png', 'test_image3.jpeg']
