...
from views.labels import IMAGE_TO_PDF_TAB_TITLE, MERGE_PDF_TAB_TITLE

from views.ViewAggregator import ViewAggregator
...
class MergerApp(QMainWindow):
    ...
    def initializeAppUI(self):
        ...
        self.tabs.addTab(self.viewAggregtor.imageToPDFMergeView.getTab(), IMAGE_TO_PDF_TAB_TITLE)
        self.tabs.addTab(self.viewAggregtor.pdfCollectionMergeView.getTab(), MERGE_PDF_TAB_TITLE)
